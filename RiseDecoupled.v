...
Inductive triples_RD : event even odd -> transitions_RD -> event even odd -> Prop :=
...
Proof.
  ...
  + subst. unfold fire.
    ...
    try omega.
    2:{ clear n3. contradict n2.

        apply <- in_output_event; eauto.
        eexists. 
...
Proof.
  intros t; induction t as [P | e t];
    ...
    inversion Hm; subst;
    unfold fire in Henabled; simpl in Henabled;
    find_contradiction;
    match goal with
